...
# Creates directory for downloads, and downloads node 6.9.1
cd ~/ && mkdir temp && cd temp;
wget https://nodejs.org/dist/v6.9.1/node-v6.9.1-linux-armv6l.tar.gz;
tar -xzf node-v6.9.1-linux-armv6l.tar.gz;
# Remove the tar after extracing it.
sudo rm node-v6.9.1-linux-armv6l.tar.gz;
# This line will clear existing nodejs
sudo rm -rf /opt/nodejs;
# This next line will copy Node over to the appropriate folder.
sudo mv node-v6.9.1-linux-armv6l /opt/nodejs/;
