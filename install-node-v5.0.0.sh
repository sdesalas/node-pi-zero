...
# Creates directory for downloads, and downloads node 5.0.0
cd ~/ && mkdir temp && cd temp;
wget https://nodejs.org/dist/v5.0.0/node-v5.0.0-linux-armv6l.tar.gz;
tar -xzf node-v5.0.0-linux-armv6l.tar.gz;
# Remove the tar after extracing it.
sudo rm node-v5.0.0-linux-armv6l.tar.gz;
# This line will clear existing nodejs
sudo rm -rf /opt/nodejs
# This next line will copy Node over to the appropriate folder.
sudo mv node-v5.0.0-linux-armv6l /opt/nodejs/;
